...
public class Cola {
    ...
    public void imprimir(JTextArea tx, JLabel label, JTable tabla) {//imprime la cola en la interfaz
        ...
        while (impr != p) {//se repite hasta encontrar el ultimo nodo ",  Tiempo de ráfaga:  " + impr.tiempo_final +
            //txt = txt + "Proceso: " + impr.proceso + ",  Tiempo de ráfaga:  " + impr.tiempo_final + ":  Tiempo ejecutado:  " + impr.tiempo_cpu  + ",  Tiempo de espera:  " + impr.tiempo_en_espera +  "\n";
...
//        //System.out.println("****************************************************************");
    ...
    public void eliminarNodo(Nodo eliminar) {//elimina un nodo en cualquier posición
        ...
        if (num != 1) {
            ...
            if(eliminar.sig==this.p)cab=asignar;
        } else {
