    ...
    public void Componentes() {
        ...
        procesos.setModel(new javax.swing.table.DefaultTableModel(
                ...
                new String[]{
                    ...
                    "Tiempo de comienzo", "Tiempo de finalización", "Tiempo de espera"
                }
        ) {
        ...
        //caja.setCursor(mano);
        gant.setBackground(new Color(32, 50, 72));
        gant.setForeground(new Color(235, 196, 56));
