...
public class Ventana extends JFrame implements ActionListener {
    ...
    public void PanelIzq() {
        ...
        panelIzquierdo.setBounds(0, 0, (getWidth() / 2) -150, getHeight());
    ...
    public void Componentes() {
        ...
        caja1.setModel(new javax.swing.table.DefaultTableModel(
                ...
                new String[]{
                    "Proceso", "Tiempo de llegada", "Tiempo de ráfaga", "Tiempo de comienzo", "Tiempo de finalización", "Tiempo de espera"
                }
        ) {
        ...
        scroll2.setBounds((getWidth() / 2) -150 + 10, 350, 660, 230);
        ...
        caja2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            boolean[] canEdit = new boolean[]{
                true, true, true, true, true, true, true, true, false, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true
            };
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (operar == e.getSource()) {
            ...
            if (opcion.equals("✔ Crear Procesos")) {
                ...
                controlador.vaciarTabla(caja1);
                controlador.insertarEnCola();
                if (controlador.getCola() != null) {
                    caja2.selectAll();
                    controlador.agregarProceso(caja1, caja2);
                    controlador.start();
                }
